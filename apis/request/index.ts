...
export default class Request {
  ...
  setDeviceInfo(deviceInfo: string) {
    this.api.defaults.headers.common = { ...this.api.defaults.headers.common, Device: deviceInfo };
  }
  ...
  post = <T = any>(url: string, body?: any, config: AxiosRequestConfig = {}, options?: IOptions) => {
    let cancel: Canceler;
  ...
  patch = <T = any>(url: string, body?: any, config: AxiosRequestConfig = {}, options?: IOptions) => {
    let cancel: Canceler;
